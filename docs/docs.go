...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/resource/{resource_id}/android-player": {
            "get": {
                "description": "Generates a ready-to-play HLS url (and optional subtitles) for Android players.",
                "consumes": [
                    "*/*"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "path inside resource (optional; if omitted the first playable video is selected)",
                        "name": "path",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/services.AndroidPlayerResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/resource/{resource_id}/android-player/{content_id}": {
            "get": {
                "description": "Generates a ready-to-play HLS url (and optional subtitles) for Android players.",
                "consumes": [
                    "*/*"
    ...
    "definitions": {
        "services.AndroidPlayerResponse": {
            "type": "object",
            "properties": {
                "hls_url": {
                    "type": "string"
